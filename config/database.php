...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'db_toko' => [
            'driver' => env('DB_CONNECTION_db_toko'),
            'host' => env('DB_HOST_db_toko', '127.0.0.1'),
            'port' => env('DB_PORT_db_toko', '3306'),
            'database' => env('DB_DATABASE_db_toko', 'forge'),
            'username' => env('DB_USERNAME_db_toko', 'forge'),
            'password' => env('DB_PASSWORD_db_toko', ''),
            'unix_socket' => '',
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
